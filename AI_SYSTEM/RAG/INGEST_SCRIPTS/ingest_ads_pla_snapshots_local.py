...
# ========== CONFIGURATION ==========
DATA_FOLDER = r"C:\Users\Sandeep\Desktop\roborana_ai_system\RoboRana_AI_Data\DATA\ADS\PLA"
CHROMA_PATH = r"C:\Users\Sandeep\Desktop\roborana_ai_system\RoboRana_AI_Data\AI_SYSTEM\RAG\VECTOR_DB"
COLLECTION_NAME = "ads_pla"
...
if not csv_files:
    raise FileNotFoundError("❌ No CSV files found in PLA folder.")

print(f"\n📂 Found {len(csv_files)} PLA reports. Reading and combining...\n")
...
for file in tqdm(csv_files):
    try:
        ...
        snapshot_info = filename.replace("PLA_Data_", "").replace(".csv", "")
